...
function openAirport() {
  ...
  document.getElementById("airportPanel").style.height = "507px";
  document.getElementById("infobar").style.visibility = "visible"
  var ctx = document.getElementById('airport_chart').getContext('2d');
  var myChart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              label: '# of Votes',
              data: [2, 4, 3, 5, 2, 3,7,7,9,10,11,12],
              backgroundColor: [
                  'rgba(255, 99, 132, 0.2)',
                  'rgba(54, 162, 235, 0.2)',
                  'rgba(255, 206, 86, 0.2)',
...
function openEurope() {
  document.getElementById("europePanel").style.height = "507px";
...
function closeAirport() {
  document.getElementById("airportPanel").style.height = "0";
};
function openWorld() {
  document.getElementById("infobar").style.visibility = "hidden"
  document.getElementById("play").style.visibility = "visible"
  document.getElementById("worldPanel").style.height = "507px";
...
function closeWorld(){
  document.getElementById("worldPanel").style.height = "0";
};
function closeEurope() {
  document.getElementById("europePanel").style.height = "0";
};
